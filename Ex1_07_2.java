...
class Ex1_07_2 {
	public static void main (String[] args) {
		...
		long  calc1_3 = 300000000000 ;                   //(10行目)処理が正常に通るようにデバッグしてください
		_____ answer1 = calc1_1 + calc1_2 + calc1_3 ;    //(11行目)アンダーバーに適切な処理を埋めてください
		...
		_____  answer2 = calc2_1 + calc2_2 + calc2_3 ;   //(18行目)アンダーバーに適切な処理を埋めてください
		...
		int    answer3 = calc3_1 + calc3_2 + calc3_3 ;   //(25行目)処理が正常に通るようにデバッグしてください
		System.out.println( answer3 );                   //(26行目)「24」が表示されているか確認してください
		
		
		int    calc4_1 = 10 ;                            //(29行目)変更しないでください
		long   calc4_2 = 11 ;                            //(30行目)変更しないでください
		int    answer4 = calc4_1 + calc4_2 ;             //(31行目)処理が正常に通るようにデバッグしてください（キャストを使用してください）
